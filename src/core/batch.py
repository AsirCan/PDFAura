...
def batch_compress_dir(input_dir, output_dir, quality="screen", progress_callback=None):
    """
    ...
    for idx, pdf in enumerate(pdfs):
        ...
        try:
            # We call the main compress module
...
def batch_convert_dir(input_dir, output_dir, mode="img2pdf", progress_callback=None):
    """
...
def batch_rename_dir(input_dir, output_dir, naming_rule, progress_callback=None):
    """
